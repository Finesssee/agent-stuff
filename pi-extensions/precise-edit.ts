...
export default function (pi: ExtensionAPI) {
	pi.registerTool({
		...
		label: "precise_edit",
		description:
			"Edit a single file with exact replacements. Use oldText and newText for one precise replacement. Use edits for multiple precise replacements in the same file.",
